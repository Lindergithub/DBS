        ...
        <tbody>
          {contact.map(contact => (
            <tr key={contact.contact_id}>
              ...
              <td>
                <button onClick={() => handleEditClick(contact)}>B_Edit</button>
              </td>
              <td>
                <button onClick={() => {
              ...
              Axios.put(`http://localhost:3001/api/contacts/${selectedContact.contact_id}`, {
                ...
                setContacts(contact.map(contact => {
                  if (contact.contact_id === selectedContact.contact_id) {
                    return {...contact, contact_name: selectedContact.contact_name, contact_phone: selectedContact.contact_phone
