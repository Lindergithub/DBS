...
class traveler {
    ...
    static getByTravelerId(connection, traveler_id, callback) {
        const sql = "SELECT * FROM contact WHERE traveler_id = ?";
    ...
    static create(connection, tour_id, contact_id, traveler_name, traveler_birth, traveler_id_number, traveler_gender,traveler_diet_habits, callback) {
        const sql = "INSERT INTO contact (traveler_id, tour_id, contact_id, traveler_name, traveler_birth, traveler_id_number, traveler_gender,traveler_diet_habits) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
